    ...
    <div class="header-bar d-flex justify-content-between border-bottom">
        <div class="d-flex align-items-center">
            <a href="#" class="logo-icon">
                ...
                <span class="big">
                    <img src="{{ asset('assets/images/logo-dark.png') }}" height="22" class="logo-light-mode"
                        alt="">
                ...
                <div class="dropdown dropdown-primary">
                    <button type="button" class="btn btn-pills btn-soft-primary dropdown-toggle p-0"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                            src="{{ asset('assets/images/language/american.png') }}"
                    ...
                    <div class="dropdown-menu dd-menu drop-ups dropdown-menu-end shadow border-0 mt-3 p-2"
                        data-simplebar style="height: 75px;">
                        <a href="javascript:void(0)" class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/language/chinese.png') }}"
                        ...
                        <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                            <img src="{{ asset('assets/images/language/european.png') }}"
                                class="avatar avatar-client rounded-circle shadow" alt="">
                            <div class="flex-1 text-left ms-2 overflow-hidden">
            ...
            <li class="list-inline-item mb-0 ms-1">
                <div class="dropdown dropdown-primary">
                    <button type="button" class="btn btn-icon btn-pills btn-soft-primary dropdown-toggle p-0"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="mail"
                    ...
                    <div class="dropdown-menu dd-menu dropdown-menu-end shadow rounded border-0 mt-3 px-2 py-2"
                        ...
                        <a href="#" class="d-flex align-items-center justify-content-between py-2">
                            <div class="d-inline-flex position-relative overflow-hidden">
                                ...
                                <small class="text-dark mb-0 d-block text-truncat ms-3">You received a new
                                    email from <b>Janalia</b> <small class="text-muted fw-normal d-inline-block">1 hour
                                        ago</small></small>
                            </div>
                        </a>
                        ...
                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                            <div class="d-inline-flex position-relative overflow-hidden">
                                <img src="https://shreethemes.in/doctris/layouts/assets/images/client/Codepen.svg"
                                    class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                <small class="text-dark mb-0 d-block text-truncat ms-3">You received a new
                                    email from <b>codepen</b> <small class="text-muted fw-normal d-inline-block">4 hour
                                        ago</small></small>
                            </div>
                        </a>
                        ...
                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                            <div class="d-inline-flex position-relative overflow-hidden">
                                <img src="{{ asset('assets/images/client/03.jpg') }}"
                                    class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                <small class="text-dark mb-0 d-block text-truncat ms-3">You received a new
                                    email from <b>Cristina</b> <small class="text-muted fw-normal d-inline-block">5
                                        hour
                                        ago</small></small>
                            </div>
                        </a>
                        ...
                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                            <div class="d-inline-flex position-relative overflow-hidden">
                                <img src="https://shreethemes.in/doctris/layouts/assets/images/client/dribbble.svg"
                                    class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                <small class="text-dark mb-0 d-block text-truncat ms-3">You received a new
                                    email from <b>Dribbble</b> <small class="text-muted fw-normal d-inline-block">24
                                        hour
                                        ago</small></small>
                            </div>
                        </a>
                        ...
                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                            <div class="d-inline-flex position-relative overflow-hidden">
                                <img src="{{ asset('assets/images/client/07.jpg') }}"
                                    class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                <small class="text-dark mb-0 d-block text-truncat ms-3">You received a new
                                    email from <b>Calvin</b> <small class="text-muted fw-normal d-inline-block">2 day
                                        ago</small></small>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3"
                        ...
                        <a class="dropdown-item text-dark" href="index.html"><span
                                class="mb-0 d-inline-block me-1"><i
                                    class="ri-dashboard-line align-middle h6"></i></span> Dashboard</a>
                        <a class="dropdown-item text-dark" href="{{ route('profile.show') }}"><span
                                class="mb-0 d-inline-block me-1"><i
                                    class="ri-user-settings-line align-middle h6"></i></span> Profile
                            Settings</a>
                        ...
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            ...
                            <a class="dropdown-item text-dark" href="#"
                                ...
                                <span class="mb-0 d-inline-block me-1">
                                    <i class="ri-logout-box-r-line align-middle h6"></i>
                                </span> Logout
                            </a>
                        </form>
