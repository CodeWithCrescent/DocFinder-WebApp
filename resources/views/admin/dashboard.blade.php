        ...
        <div class="col-xl-4 col-lg-6 mt-4">
            <div class="card chat chat-person border-0 shadow rounded">
                ...
                <ul class="p-4 list-unstyled mb-0 chat" data-simplebar
                    style="background: url('{{ asset('assets/images/bg/bg-chat.png') }}') center center; max-height: 295px;">
                    <li>
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    ...
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>59 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    ...
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>45 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="chat-right">
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    <p class="text-muted small shadow px-3 py-2 bg-light rounded mb-1">How can i help you?
                                    </p>
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>44 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    ...
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>42 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    <p class="text-muted small shadow px-3 py-2 bg-light rounded mb-1">Hope you are doing
                                        fine?</p>
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>40 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="chat-right">
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    <p class="text-muted small shadow px-3 py-2 bg-light rounded mb-1">I'm good thanks for
                                        asking</p>
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>45 min
                                        ago</small>
                                </div>
                    ...
                    <li>
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    <p class="text-muted small shadow px-3 py-2 bg-light rounded mb-1">I am intrested to
                                        know more about your prices and services you offer</p>
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>35 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="chat-right">
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    <p class="text-muted small shadow px-3 py-2 bg-light rounded mb-1">Sure please check
                                        below link to find more useful information <a
                                            href="https://1.envato.market/doctris-template" target="_blank"
                                            class="text-primary">https://shreethemes.in/Doctris/</a></p>
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>25 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    ...
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>20 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-inline-block">
                            <div class="d-flex chat-type mb-3">
                                ...
                                <div class="flex-1 chat-msg" style="max-width: 500px;">
                                    ...
                                    <small class="text-muted msg-time"><i class="uil uil-clock-nine me-1"></i>18 min
                                        ago</small>
                                </div>
                            </div>
                        </div>
